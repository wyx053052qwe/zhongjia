...
{{--                @endforeach--}}
        ...
        <div class="right Float_right mr_right shopxq-right">
            <div class="i_tit"> <label class="ft_18 Color1 font-f2">                联系我们                                </label>
                <p>当前位置:首页 &gt; 联系我们 </p>
            </div>
            <div class="i_bor">
                ...
                <!--联系我们  -->
                <div class="qk-ly">
                    <div class="qk-title">联系我们 </div>
                </div>
                <div class="i_bor">
                    <div class="shop-netcn">
                        <p>期刊邮箱投稿：cnzazhi@yeah.net</p>
                        <p class="shop-zy">注：邮箱投稿请注明作者联系方式和我刊刊名，我刊收到稿件后1-2日内及时回复！</p>
                        <table>
                            <tbody>

                            <tr>
                                <td style="width:150px">
                                    <h3><img src="{{asset('statics/images/qq2.png')}}" style="height:18px; width:18px">&nbsp;杂志社在线编辑</h3>
                                </td>
                                <td><a href="http://wpa.qq.com/msgrd?v=3&amp;uin=185841075&amp;site=qq&amp;menu=yes">QQ：185841075</a><span class="shop-email">E-mail：185841075@qq.com</span></td>
                            </tr>
                            <tr>
                                <td style="width:150px">
                                    <h3><img src="{{asset('statics/images/qq2.png')}}" style="height:18px; width:18px">&nbsp;杂志社在线编辑</h3>
