...
@section('content')
    ...
    <div class="top">
        <div class="sy-top top-top">
            ...
            <li>
                <a href="" target="_blank"><img height="130" width="100" class="imgs" src="{{asset('uploads/'.$jodata['j_thumbnail'])}}" alt="{{$jodata['j_title']}}" border="0" style="padding: 10px 0px 10px 0px;"></a>
            </li>
...
{{--                @endforeach--}}
    ...
    <div class="right Float_right mr_right shopxq-right">
        <div class="i_tit"> <label class="ft_18 Color1 font-f2">                期刊简介                                </label>
            <p>当前位置:首页 &gt; 期刊简介 </p>
        </div>
        <div class="i_bor">
