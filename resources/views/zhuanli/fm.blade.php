...
<div class="w1200">
    ...
    <div class="kec">
        <p class="prona1">|
            <font color="#000000">发明专利</font> |</p>
    </div>
    <div class="lv_mmtopc">
        <div class="search">
            <form action="{{url('zhuanli/fm')}}" method="get" onsubmit="">
    ...
    <div class="prolanmu1">
        <div class="pro_lanfra" style="padding-bottom:0">
            ...
            <span><a href="?classid=16" title="发明专利" class="">发明专利</a></span>
...
@foreach($data as $d)
            <li>
                <a href="{{url('zhuanli/next')}}/{{$d->a_id}}/{{$d->c_id}}" title="{{$d->a_title}}"><img src="{{asset('uploads/'.$d->a_photos)}}" alt="{{$d->a_title}}" width="220" height="165">
                    <p>{{$d->a_title}}</p>
                </a>
            </li>
@endforeach
