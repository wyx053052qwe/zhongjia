...
"1006*老人节","1024*联合国日","1112*孙中山诞辰","1220*澳门回归纪念","1225*圣诞节","1226*毛泽东诞辰")
  ...
  /*  festival = '<font color="#FF0000" style="font-size:9pt;">'+solarTerms + ' ' + solarFestival + ' ' + lunarFestival+'';*/
   festival = '<font color="#FF0000" style="font-size:9pt;">'+solarTerms + ' ' + solarFestival + ' ' + lunarFestival+'';    
  var cl = '';
  return(cl+festival+'');
 ...
 function setCalendar(){
	 //document.write('<font color=#ff0000><strong>现在是：</strong>'+YYMMDD()+'&nbsp;'+weekday() + "&nbsp;");
